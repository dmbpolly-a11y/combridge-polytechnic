...
_Last synced: 2026-09-12T15:23:18.649Z._
...
- `c:\Users\AFRICA\Desktop\COMBRIDGE POLYTECHNIC SYTEM\.vscode\mcp.json` _(workspace: COMBRIDGE POLYTECHNIC SYTEM)_ — _file missing_

_No active workspace servers in mcp.json._

#### User MCP

- `C:\Users\AFRICA\AppData\Roaming\Code\User\mcp.json` — _file missing_
...
- **skill-creator** — `C:\Users\AFRICA\.claude\skills\skill-creator` — Create new skills, modify and improve existing skills. Use when users want to create a skill from scratch, edit, or optimize an existing skill.
